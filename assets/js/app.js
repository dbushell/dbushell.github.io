...
var Bio = function Bio(props) {
  ...
  return React.h(
    ...
    React.h(
      ...
      React.h('img', { src: props.imageSrc, srcSet: props.imageSrcset, alt: props.imageAlt })
    ),
    React.h(
      'div',
...
var items$1 = [{ "id": "the-magic-of-service-workers", "title": "The Magic of Service Workers", "href": "/2017/04/06/the-magic-of-service-workers/", "date": 1491472800000 }, { "id": "i-watched-iron-fist-and-coded-css", "title": "I watched Iron Fist and coded CSS 👈", "href": "/2017/04/03/i-watched-iron-fist-and-coded-css/", "date": 1491213600000 }, { "id": "web-security-and-cloudflare", "title": "Web Security and Cloudflare", "href": "/2017/02/17/web-security-and-cloudflare/", "date": 1487325600000 }, { "id": "react-as-a-static-site-generator", "title": "React as a Static Site Generator", "href": "/2017/02/13/react-as-a-static-site-generator/", "date": 1486980000000 }, { "id": "resolving-javascript-promises-sequentially-without-nesting", "title": "Working with Promises", "href": "/2016/12/16/resolving-javascript-promises-sequentially-without-nesting/", "date": 1481882400000 }, { "id": "my-thoughts-on-react", "title": "My thoughts on React", "href": "/2016/12/02/my-thoughts-on-react/", "date": 1480672800000 }];
var defaults$2 = {
	heading: heading,
	items: items$1
};

var Blog$$1 = function Blog$$1(props) {
  var attr = {
    className: 'b-blog',
    role: 'navigation'
  };
  return React.h(
    ...
    React.h(
      ...
      props.items.map(function (item) {
        return React.h(
          'li',
          { className: 'b-blog__item', key: item.id },
          React.h(
            'a',
            { rel: 'bookmark', href: item.href },
            item.title
          ),
          React.h(Time, { date: item.date })
        );
      })
    )
  );
...
var heading$1 = "What my clients say:";
...
var Clients$$1 = function Clients$$1(props) {
  return React.h(
    'div',
...
Clients$$1.defaultProps = defaults$3;
    ...
    React.h(
      ...
      React.h(
        ...
        React.h(
          ...
          React.h(
            'li',
            { className: 'b-folio__item', style: { backgroundColor: '#b72817' } },
            React.h(
              'a',
              { className: 'b-folio__link', href: '/2016/10/10/building-a-shopify-theme/' },
              React.h(
                'span',
                { className: 'b-folio__label' },
                'Shopify Theme'
              ),
              React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/stshopify.png', alt: 'Building a Shopify Theme' })
            )
          ),
          React.h(
            'li',
            { className: 'b-folio__item', style: { backgroundColor: '#d8ac59' } },
            React.h(
              'a',
              { className: 'b-folio__link', href: '/2015/03/18/responsive-design-for-houden/' },
              React.h(
                'span',
                { className: 'b-folio__label' },
                'Houden'
              ),
              React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/houden.png', alt: 'Houden' })
            )
          ),
          React.h(
            'li',
            { className: 'b-folio__item', style: { backgroundColor: '#993300' } },
            React.h(
              'a',
              { className: 'b-folio__link', href: '/2014/05/07/responsive-design-for-uwe-wittwer/' },
              React.h(
                'span',
                { className: 'b-folio__label' },
                'Uwe Wittwer'
              ),
              React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/uwewittwer.png', alt: 'Uwe Wittwer' })
            )
          )
        )
      )
...
var Footer$$1 = function Footer$$1(props) {
  var attr = {
    id: 'footer',
  ...
  var hire = React.h(
    ...
    React.h('img', { className: 'b-hire__image', src: '/assets/img/dbushell-for-hire.svg', alt: 'Available for Hire' })
  );
  return React.h(
    'footer',
    attr,
...
var Hero$$1 = function Hero$$1(props) {
  return React.h(
    'header',
    { className: 'c-hero' },
    React.h(
...
Hero$$1.defaultProps = defaults$5;

var Icon = function Icon(props) {
  var icon = function icon(id) {
    return { __html: "<use xlink:href=\"/assets/img/icons.svg#" + id + "\"></use>" };
  };
  return React.h("svg", { role: "presentation", dangerouslySetInnerHTML: icon(props.id) });
};
...
var heading$3 = "Website Navigation";
...
var Nav$$1 = function Nav$$1(props) {
  return React.h(
    'nav',
    ...
    React.h(
      ...
      props.items.map(function (item) {
        return React.h(
          'li',
          { key: item.order, className: 'b-nav__item', 'data-priority': item.priority, 'data-order': item.order },
          React.h(
            'a',
            { href: item.href, className: 'b-nav__link' },
            item.text
          )
        );
      }),
      React.h(
        'li',
        { className: 'b-nav__item b-nav__item--icons', 'data-priority': props.items.length + 1, 'data-order': props.items.length + 1 },
        React.h(
          'a',
          { className: 'b-nav__link', rel: 'me noopener noreferrer', target: '_blank', title: 'David Bushell on Twitter', href: 'http://twitter.com/dbushell' },
        ...
        React.h(
          'a',
          { className: 'b-nav__link', rel: 'me noopener noreferrer', target: '_blank', title: 'David Bushell on GitHub', href: 'https://github.com/dbushell/' },
        ...
        React.h(
          'a',
          { className: 'b-nav__link', rel: 'me noopener noreferrer', target: '_blank', title: 'David Bushell on CodePen', href: 'http://codepen.io/dbushell/' },
...
var Newsletter = function Newsletter() {
  return React.h(
    ...
    React.h(
      ...
      React.h(
        "form",
        { noValidate: true, className: "b-form", id: "newsletter", action: "//dbushell.us1.list-manage.com/subscribe/post?u=f1621b8d47b205bc9a898c68f&id=84a4c62ca9", method: "post", name: "mc-embedded-subscribe-form", target: "_blank" },
        React.h(
          "div",
          { className: "b-form__item" },
          React.h(
            "label",
            { htmlFor: "mce-EMAIL", className: "e-label" },
            "Email Address"
          ),
          React.h("input", { type: "email", name: "EMAIL", className: "e-field", id: "mce-EMAIL", placeholder: "me@example.com\u2026" })
        ),
        React.h(
          "div",
          { className: "b-form__item" },
          ...
          React.h(
            ...
            React.h("input", { defaultChecked: true, className: "u-vh", type: "radio", value: "html", name: "EMAILTYPE", id: "mce-EMAILTYPE-0" }),
            React.h(
              "span",
              null,
              "HTML"
          ...
          React.h(
            ...
            React.h("input", { className: "u-vh", type: "radio", value: "text", name: "EMAILTYPE", id: "mce-EMAILTYPE-1" }),
            React.h(
              "span",
              null,
              "Text"
        ...
        React.h(
          ...
          React.h(
            ...
            React.h("input", { type: "text", name: "b_f1621b8d47b205bc9a898c68f_84a4c62ca9", value: "" })
          ),
          React.h("input", { className: "e-button", type: "submit", value: "Subscribe", name: "subscribe" })
        )
      )
    )
  );
...
var Sector$$1 = function Sector$$1(props) {
  var attr = {
    className: 'b-sector'
  };
  var buttonAttr = _extends({}, props.button, {
    bg1: !props.alt,
    bg2: props.alt,
    shadow: true
  });
    ...
    React.h(
      ...
      React.h(
        ...
        React.h(
          ...
          React.h(Sector$$1, items$$1[0])
        ),
        React.h(
          'div',
          { className: 'c-sectors__item' },
          React.h(Sector$$1, items$$1[1])
        )
      )
    )
  );
...
Sectors$$1.defaultProps = defaults$7;
...
var Steps$$1 = function Steps$$1(props) {
  ...
  props.items.forEach(function (item, i) {
    items$$1.push(React.h(
      'article',
      { key: id(), className: 'c-steps__item' },
      React.h(
        'h2',
        { className: 'h4' },
        React.h(
      ...
      item.button ? React.h(Button, item.button) : null
    ));
...
Steps$$1.defaultProps = defaults$8;
...
var Archive = function Archive(props) {
  var nextButton = props.nextPage ? React.h(
    'a',
    { href: props.nextPage, className: 'e-button' },
    'Older'
  ) : null;
  var prevButton = props.prevPage ? React.h(
    'a',
    { href: props.prevPage, className: 'e-button' },
    'Newer'
  ) : null;
  ...
  props.excerpts.forEach(function (item) {
    items.push(React.h(Excerpt$$1, _extends({ key: item.id }, item)));
    ...
    React.h(
      ...
      React.h(
        ...
        React.h(
          ...
          React.h(
            'form',
            { className: 'b-form', id: 'contact-form', method: 'post', action: 'https://formspree.io/hi@dbushell.com' },
            React.h('input', { type: 'hidden', name: '_next', value: 'http://dbushell.com/contact/?success=true' }),
            React.h('input', { type: 'hidden', name: '_subject', value: 'dbushell.com enquiry' }),
            React.h(
              'ul',
              ...
              React.h(
                ...
                React.h(Field, { type: 'email', id: 'contact-email', name: '_replyto', placeholder: 'me@example.com\u2026' })
              ),
              React.h(
                'li',
                { className: 'b-form__item' },
                ...
                React.h('textarea', { required: true, className: 'e-field e-field--area', id: 'contact-enquiry', name: 'enquiry', rows: '5' })
              ),
              React.h(
                'li',
                { className: 'b-form__item u-vh' },
                React.h(Label, { field: 'contact-human', text: 'If you\u2019re human leave the next field blank!' }),
                React.h('input', { type: 'text', id: 'contact-human', name: '_gotcha', tabIndex: '-1' })
              ),
              React.h(
                'li',
                { className: 'b-form__item' },
...
var Home = function Home() {
  return React.h(
    Block,
    { main: true, classList: ['c-main--home'] },
    React.h(Hero$$1, null),
    React.h(Steps$$1, null),
    React.h(Sectors$$1, null),
    React.h(Folio$$1, null),
    React.h(Clients$$1, null)
  );
};
...
var Page = function Page(props) {
  var postBody = props.innerHTML ? React.h('div', { className: 'b-post__body', dangerouslySetInnerHTML: { __html: props.innerHTML } }) : React.h(
    'div',
    { className: 'b-post__body' },
    props.children
  );
    ...
    React.h(
      ...
      React.h(
        ...
        React.h(
          'div',
          { className: 'b-post__pattern' },
          React.h(Sector$$1, Sectors$$1.defaultProps.items[1])
        ),
        React.h(
          'h2',
          null,
        ...
        React.h(
          'div',
          { className: 'b-post__pattern' },
          React.h(Sector$$1, Sectors$$1.defaultProps.items[0])
        )
      )
    )
  );
        ...
        React.h(
          ...
          React.h(
            ...
            React.h(
              ...
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#29313d' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/2016/07/14/building-a-wordpress-theme/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'Base Creative / WordPress'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/bcwordpress.png', alt: 'Building a WordPress Theme designed by Base Creative, London' })
                )
              ),
              React.h(
                'li',
              ...
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#f05b26' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/2016/01/04/css-framework-for-partsgiant/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'PartsGiant'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/partsgiant.jpg', alt: 'PartsGiant' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#5798da' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/2014/02/17/introducing-tales/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'Tales'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/tales.jpg', alt: 'Tales' })
                )
              )
            )
          ),
          ...
          React.h(
            ...
            React.h(
              ...
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#45b0e5' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/showcase/origami-unfolded/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'Origami Unfolded'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/origami.jpg', alt: 'Origami Unfolded' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#661f1f' } },
                React.h(
                  'a',
                  ...
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/machinal.jpg', alt: 'Machinal' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#e57300' } },
                React.h(
                  'a',
                  ...
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/space.jpg', alt: 'Space Opera' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#e5c72e' } },
                React.h(
                  'a',
                  ...
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/seized.jpg', alt: 'Seized' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#47b247' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/showcase/digital-legibility/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'Digital Legibility'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/digital.jpg', alt: 'Digital Legibility' })
                )
              ),
              React.h(
                'li',
                { className: 'b-folio__item', style: { backgroundColor: '#3c3c3c' } },
                React.h(
                  'a',
                  { className: 'b-folio__link', href: '/showcase/tamed-aggression/' },
                  React.h(
                    'span',
                    { className: 'b-folio__label' },
                    'Tamed Aggression'
                  ),
                  React.h('img', { className: 'b-folio__image', src: '/assets/img/portfolio/tamed.jpg', alt: 'Tamed Aggression' })
                )
              )
            )
          ),
